...
fn update(app: &App, model: &mut Model, update: Update) {
    ...
    egui::Window::new("Shader Settings").show(&ctx, |ui| {
        ui.add(egui::Slider::new(&mut model.settings.lambda, 0.5..=2.5).text("l"));
        ui.add(egui::Slider::new(&mut model.settings.theta, 0.5..=2.5).text("b"));
        ui.add(egui::Slider::new(&mut model.settings.alpha, 5.0..=20.0).text("g"));
        ui.add(egui::Slider::new(&mut model.settings.sigma, 6.0..=24.0).text("Mid Sigma"));
        ui.add(egui::Slider::new(&mut model.settings.gamma, 3.0..=12.0).text("Fog Density"));
        ui.add(egui::Slider::new(&mut model.settings.blue, -2.0..=1.0).text("Fogc"));
        ui.add(egui::Slider::new(&mut model.settings.a, 0.5..=2.0).text("er"));
        ui.add(egui::Slider::new(&mut model.settings.b, 0.0..=0.01).text("eg"));
        ui.add(egui::Slider::new(&mut model.settings.c, 0.0..=0.1).text("eb"));
        ui.add(egui::Slider::new(&mut model.settings.d, 0.2..=0.8).text("Bre"));
        ui.add(egui::Slider::new(&mut model.settings.e, 0.05..=0.2).text("Bgre"));
        ui.add(egui::Slider::new(&mut model.settings.f, 0.05..=0.2).text("Bbe"));
        ui.add(egui::Slider::new(&mut model.settings.g, 0.3..=1.2).text("Lighting Power"));
        ui.add(egui::Slider::new(&mut model.settings.iter, 0.4..=1.6).step_by(0.1).text("Iterations"));
        ui.add(egui::Slider::new(&mut model.settings.bound, 1.25..=5.0).text(" Bound"));
        ui.add(egui::Slider::new(&mut model.settings.aa, 0.1..=4.0).text("Anti-Aliasing"));
        ui.add(egui::Slider::new(&mut model.settings.tt, 0.0001..=0.01).text("Normal Epsilon"));
    });
...
fn model(app: &App) -> Model {
    ...
    let fs_desc = wgpu::include_wgsl!("../shaders/kleinian.wgsl");
