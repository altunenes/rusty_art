...
fn update(app: &App, model: &mut Model, update: Update) {
    ...
    egui::Window::new("Shader Settings").show(&ctx, |ui| {
        ui.add(egui::Slider::new(&mut model.settings.lambda, 0.0..=180.0).text("iter"));
        ui.add(egui::Slider::new(&mut model.settings.theta, 0.0..=1.0).text("Flake_R"));
        ui.add(egui::Slider::new(&mut model.settings.alpha, 0.0..=1.0).text("Flake_G"));
        ui.add(egui::Slider::new(&mut model.settings.sigma, 0.0..=1.0).text("Flake_B"));
        ui.add(egui::Slider::new(&mut model.settings.gamma, 0.0..=360.0).text("radian"));
        ui.add(egui::Slider::new(&mut model.settings.blue, 0.0..=1.0).text("snowflake"));
        ui.add(egui::Slider::new(&mut model.settings.a, 0.0..=88.0).text("steps"));
        ui.add(egui::Slider::new(&mut model.settings.b, 0.0001..=1.0).text("normal_min"));
        ui.add(egui::Slider::new(&mut model.settings.c, 0.0001..=1.0).text("normal_max"));
        ui.add(egui::Slider::new(&mut model.settings.d, 0.0..=24.0).text("oscil"));
...
fn model(app: &App) -> Model {
    ...
    let fs_desc = wgpu::include_wgsl!("../shaders/winterflake.wgsl");
