...
fn update(app: &App, model: &mut Model, update: Update) {
    ...
    egui::Window::new("Shader Settings").show(&ctx, |ui| {
        ui.add(egui::Slider::new(&mut model.settings.lambda, 0.0..=3.14).text("df"));
        ui.add(egui::Slider::new(&mut model.settings.theta, 0.0..=5.0).text("hue"));
        ui.add(egui::Slider::new(&mut model.settings.sigma, 0.0..=1.0).text("mix?"));
        ui.add(egui::Slider::new(&mut model.settings.gamma, 0.0..=2.0).text("gamma"));
        ui.add(egui::Slider::new(&mut model.settings.blue, 0.0..=12.0).text("red"));
...
fn model(app: &App) -> Model {
    ...
    let fs_desc = wgpu::include_wgsl!("../shaders/sdrect.wgsl");
