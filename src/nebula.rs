...
fn update(app: &App, model: &mut Model, update: Update) {
    ...
    egui::Window::new("Shader Settings").show(&ctx, |ui| {
        ui.add(egui::Slider::new(&mut model.settings.lambda, -1.5..=1.5).text("l"));
        ui.add(egui::Slider::new(&mut model.settings.theta, -1.5..=1.5).text("t"));
        ui.add(egui::Slider::new(&mut model.settings.alpha, 0.0..=25.5).text("a"));
        ui.add(egui::Slider::new(&mut model.settings.sigma, 0.0..=500.0).text("iter"));
        ui.add(egui::Slider::new(&mut model.settings.gamma, 0.0..=500.0).text("bound"));
...
fn model(app: &App) -> Model {
    ...
    let fs_desc = wgpu::include_wgsl!("../shaders/nebula.wgsl");
