...
fn update(app: &App, model: &mut Model, update: Update) {
    ...
    egui::Window::new("Shader Settings").show(&ctx, |ui| {
        ui.add(egui::Slider::new(&mut model.settings.lambda, 0.0..=16.0).text("a"));
        ui.add(egui::Slider::new(&mut model.settings.theta, 0.0..=16.0).text("b"));
        ui.add(egui::Slider::new(&mut model.settings.alpha, 0.0..=3.0).text("time"));
        ui.add(egui::Slider::new(&mut model.settings.sigma, 0.0..=1.0).text("c1"));
        ui.add(egui::Slider::new(&mut model.settings.gamma, 0.0..=1.0).text("c2"));
        ui.add(egui::Slider::new(&mut model.settings.blue,0.5..=6.0).text("bloom"));
...
fn model(app: &App) -> Model {
    ...
    let fs_desc = wgpu::include_wgsl!("../shaders/peaceGPU.wgsl");
