...
fn update(app: &App, model: &mut Model, update: Update) {
    ...
    egui::Window::new("Shader Settings").show(&ctx, |ui| {
        ...
        ui.add(egui::Slider::new(&mut model.settings.lambda, 0.001..=0.09).text("lambda"));
        ui.add(egui::Slider::new(&mut model.settings.theta, 0.001..=0.09).text("psi"));
        ui.add(egui::Slider::new(&mut model.settings.alpha, 0.001..=0.09).text("sigma"));
        ui.add(egui::Slider::new(&mut model.settings.sigma, 0.001..=45.0).text("gamma"));
        ui.add(egui::Slider::new(&mut model.settings.gamma, 0.0..=10.0).text("size"));
        ui.add(egui::Slider::new(&mut model.settings.blue, -PI..=PI).text("env"));
    });
    if open_file_dialog {
...
fn model(app: &App) -> Model {
    ...
    let fs_desc = wgpu::include_wgsl!("../shaders/gaborimage.wgsl");
