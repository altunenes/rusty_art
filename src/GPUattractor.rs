...
fn update(app: &App, model: &mut Model, update: Update) {
    ...
    egui::Window::new("Shader Settings").show(&ctx, |ui| {
        ui.add(egui::Slider::new(&mut model.settings.lambda, -2.0..=2.0).text("a"));
        ui.add(egui::Slider::new(&mut model.settings.theta, -2.5..=2.5).text("b"));
        ui.add(egui::Slider::new(&mut model.settings.alpha, -2.0..=2.0).text("c"));
        ui.add(egui::Slider::new(&mut model.settings.sigma, -2.0..=2.0).text("d"));
        ui.add(egui::Slider::new(&mut model.settings.gamma, 1.0..=15.0).text("scale"));
        ui.add(egui::Slider::new(&mut model.settings.blue,0.5..=3.0).text("bloom"));
...
fn model(app: &App) -> Model {
    ...
    let fs_desc = wgpu::include_wgsl!("../shaders/GPUattractor.wgsl");
