...
fn update(app: &App, model: &mut Model, update: Update) {
    ...
    egui::Window::new("Shader Settings").show(&ctx, |ui| {
        ui.add(egui::Slider::new(&mut model.settings.lambda, 0.0..=5.0).text("top light"));
        ui.add(egui::Slider::new(&mut model.settings.theta, -0.01..=0.01).text("dec_bleed"));
        ui.add(egui::Slider::new(&mut model.settings.alpha, -0.4..=0.4).text("ao"));
        ui.add(egui::Slider::new(&mut model.settings.sigma, 0.0..=12.0).text("star"));
        ui.add(egui::Slider::new(&mut model.settings.gamma, 0.0..=3.0).text("light_r"));
        ui.add(egui::Slider::new(&mut model.settings.blue, 0.0..=3.0).text("light_b"));
        ui.add(egui::Slider::new(&mut model.settings.a, 0.0..=3.0).text("light_g"));
        ui.add(egui::Slider::new(&mut model.settings.b, 0.0..=0.2).text("bgr"));
        ui.add(egui::Slider::new(&mut model.settings.c, 0.0..=0.2).text("bgb"));
        ui.add(egui::Slider::new(&mut model.settings.d, 0.0..=0.2).text("bgg"));
        ui.add(egui::Slider::new(&mut model.settings.g, 0.0..=20.0).text("light1"));
        ui.add(egui::Slider::new(&mut model.settings.e, 0.002..=20.0).text("light2"));
        ui.add(egui::Slider::new(&mut model.settings.f, 0.0..=20.0).text("light3"));
        ui.add(egui::Slider::new(&mut model.settings.iter, -24.0..=24.0).text("ao_dist"));
        ui.add(egui::Slider::new(&mut model.settings.bound, 0.00001..=0.5).text("vig"));
        ui.add(egui::Slider::new(&mut model.settings.aa, 0.0..=1.0).text("gamma"));
        ui.add(egui::Slider::new(&mut model.settings.tt, -0.5..=0.5).text("starglow"));
    });
...
fn model(app: &App) -> Model {
    ...
    let fs_desc = wgpu::include_wgsl!("../shaders/2025tree.wgsl");
