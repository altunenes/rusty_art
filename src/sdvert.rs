...
fn update(app: &App, model: &mut Model, update: Update) {
    ...
    egui::Window::new("Shader Settings").show(&ctx, |ui| {
        ui.add(egui::Slider::new(&mut model.settings.lambda, 0.0..=20.0).text("vert"));
        ui.add(egui::Slider::new(&mut model.settings.theta, 0.0..=60.0).text("angle"));
        ui.add(egui::Slider::new(&mut model.settings.alpha, 0.0..=1.0).text("num_vert_min"));
        ui.add(egui::Slider::new(&mut model.settings.sigma, 0.0..=1.0).text("num_vert_max"));
        ui.add(egui::Slider::new(&mut model.settings.gamma, 1.0..=15.0).text("radi"));
        ui.add(egui::Slider::new(&mut model.settings.blue, 0.0..=12.0).text("blue"));
        ui.add(egui::Slider::new(&mut model.settings.a, 0.0..=3.0).text("depth"));
        ui.add(egui::Slider::new(&mut model.settings.b, 0.0001..=3.0).text("fold"));
        ui.add(egui::Slider::new(&mut model.settings.c, 0.0001..=1.0).text("colorshift"));
        ui.add(egui::Slider::new(&mut model.settings.d, -3.14..=3.14).text("light"));
...
fn model(app: &App) -> Model {
    ...
    let fs_desc = wgpu::include_wgsl!("../shaders/sdvert.wgsl");
