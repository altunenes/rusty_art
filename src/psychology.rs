...
fn update(app: &App, model: &mut Model, update: Update) {
    ...
    egui::Window::new("Shader Settings").show(&ctx, |ui| {
        ui.add(egui::Slider::new(&mut model.settings.lambda, 0.0..=5.0).text("l"));
        ui.add(egui::Slider::new(&mut model.settings.theta, 0.0..=0.5).text("t"));
        ...
        ui.add(egui::Slider::new(&mut model.settings.blue, 0.0..=PI).text("b"));
        ui.add(egui::Slider::new(&mut model.settings.noise, 0.0..=3.0).text("noise"));
        ui.add(egui::Slider::new(&mut model.settings.noise2, 0.0..=3.0).text("noise2"));
        ui.add(egui::Slider::new(&mut model.settings.color, 0.0..=1.0).text("red"));
        ui.add(egui::Slider::new(&mut model.settings.fw, 0.0..=1.0).text("fw"));
        ui.add(egui::Slider::new(&mut model.settings.fh, 0.0..=1.0).text("fh"));
        ui.add(egui::Slider::new(&mut model.settings.fcx, 0.0..=1.0).text("fcx"));
        ui.add(egui::Slider::new(&mut model.settings.fcy, 0.0..=1.0).text("fcy"));
...
fn model(app: &App) -> Model {
    ...
    let fs_desc = wgpu::include_wgsl!("../shaders/psychology.wgsl");
