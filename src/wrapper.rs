...
fn update(app: &App, model: &mut Model, update: Update) {
    ...
    egui::Window::new("Shader Settings").show(&ctx, |ui| {
        ...
        ui.add(egui::Slider::new(&mut model.settings.alpha, 0.0..=6.25).text("a"));
        ui.add(egui::Slider::new(&mut model.settings.sigma, 0.0..=6.25).text("r"));
        ui.add(egui::Slider::new(&mut model.settings.gamma, -12.0..=24.0).text("g"));
        ui.add(egui::Slider::new(&mut model.settings.blue, -12.0..=24.0).text("b"));
...
fn model(app: &App) -> Model {
    ...
    let fs_desc = wgpu::include_wgsl!("../shaders/wrapper.wgsl");
