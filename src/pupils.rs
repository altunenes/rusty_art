...
fn update(app: &App, model: &mut Model, update: Update) {
    ...
    egui::Window::new("Shader Settings").show(&ctx, |ui| {
        ui.add(egui::Slider::new(&mut model.settings.lambda, -PI..=15.0).text("l"));
        ui.add(egui::Slider::new(&mut model.settings.theta, -1.0..=15.5).text("t"));
        ui.add(egui::Slider::new(&mut model.settings.alpha, -0.3055..=70.05).text("a"));
        ui.add(egui::Slider::new(&mut model.settings.sigma, -0.1..=45.0).text("r"));
        ui.add(egui::Slider::new(&mut model.settings.gamma, -1.0..=5.0).text("g"));
        ui.add(egui::Slider::new(&mut model.settings.blue, 1.1..=15.0).text("b"));
...
fn model(app: &App) -> Model {
    ...
    let fs_desc = wgpu::include_wgsl!("../shaders/pupils.wgsl");
