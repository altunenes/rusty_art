//reproduction of my old GABOR code: https://www.shadertoy.com/view/cs3BWM
struct TimeUniform {
    time: f32,
};
@group(1) @binding(0)
...
fn main(@builtin(position) FragCoord: vec4<f32>) -> @location(0) vec4<f32> {
    ...
    let resolution: vec2<f32> = vec2<f32>(512.0, 512.0); // 512x512 window for simplicity
    ...
    let psi: f32 = u_time.time * 5.5; // Use the uniform time for the phase offset
